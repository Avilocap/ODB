 ...
 *
 * import java.util.regex.Pattern; import java.util.concurrent.TimeUnit; import static
 * org.junit.Assert.*; import static org.hamcrest.CoreMatchers.*;
 *
 * import org.junit.Assert; import org.junit.jupiter.api.AfterEach; import
 * org.junit.jupiter.api.BeforeEach; import org.junit.jupiter.api.Disabled; import
 * org.junit.jupiter.api.Test; import org.junit.runner.RunWith; import
 * org.openqa.selenium.*; import org.openqa.selenium.firefox.FirefoxDriver; import
 ...
 *
 * @Disabled public class LoginUITest {
 *
 ...
 * "C:\\Users\\CimaGrande\\Documents\\geckodriver.exe"); driver = new FirefoxDriver();
 * baseUrl = "https://www.google.com/"; driver.manage().timeouts().implicitlyWait(30,
 * TimeUnit.SECONDS); driver.get("http://localhost:8080/login");
 ...
 * driver.findElement(By.xpath("//input[@type='submit']")).click(); // }
 *
 * @Test public void testListApplicationsUI() throws Exception {
 * driver.findElement(By.id("appList")).click();
 * driver.findElement(By.linkText("Lone Echo")).click(); }
 *
 * @Test public void testAddToFavoritesUI() throws Exception {
 ...
 *
 * @Test public void testPaymentUI() { driver.findElement(By.id("paym")).click();
 ...
 *
 * @Test public void testAddCommentUI() {
 * driver.get("http://localhost:8080/applications/appInfo/100");
 * driver.findElement(By.id("addCom")).click();
 * driver.findElement(By.name("title")).clear();
 * driver.findElement(By.name("title")).sendKeys("Automated Test Comment");
 * driver.findElement(By.name("content")).clear(); driver.findElement(By.name("content")).
 * sendKeys("This is a test of Automated Test Comment");
 * driver.findElement(By.id("sub")).click();
 * Assert.assertTrue(driver.findElement(By.xpath(
 * "/html/body/div/div/div[3]/table/tbody/tr/td[1]")).isDisplayed());
 *
 * }
 *
 * @AfterEach public void tearDown() throws Exception { driver.quit(); String
 ...
 * driver.switchTo().alert(); String alertText = alert.getText(); if (acceptNextAlert) {
 * alert.accept(); } else { alert.dismiss(); } return alertText; } finally {
