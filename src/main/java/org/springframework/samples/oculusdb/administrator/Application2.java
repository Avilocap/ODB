...
public class Application2 {
	...
	public void setOculusId(Integer oculusId) {
	...
	public String toString() {
		return "Application [oculusId=" + this.oculusId + ", name=" + this.name + ", description=" + this.description
				+ ", releaseDate=" + this.releaseDate + ", price=" + this.price + ", website=" + this.website
				+ ", company=" + this.company + ", picture=" + this.picture + ", typeOfGameplay=" + this.typeOfGameplay
				+ ", salesEstimation=" + this.salesEstimation + ", incomeEstimation=" + this.incomeEstimation
				+ ", totalReviews=" + this.totalReviews + ", language=" + this.language + ", typeOfApp="
				+ this.typeOfApp + ", platform=" + this.platform + ", category=" + this.category + ", reviews="
				+ this.reviews + ", comments=" + this.comments + "]";
	}
